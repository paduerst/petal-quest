...
<div class="dragon-action breath-option">
	<p>
		...
		({dragon.breath1DiceCount}d{dragon.breath1DiceType}) radiant damage and is blinded until the end
		of its next turn. On a successful save, the creature just takes half as much damage.
	</p>
</div>
