...
{#if includeAgeParagraph}
	<p class="mt-2">
		Black dragons age half as fast as other prismatic dragons. They are a wyrmling for 20 years, and
		they reach adulthood at the age of 200. They become ancient at the age of 2000 and are cosmic
		for the last 20 years of their life. Instead of becoming a supernova, their cosmic form is that
		of a singularity: an implosion so great that light cannot escape.
	</p>
{/if}
